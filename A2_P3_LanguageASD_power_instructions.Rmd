...
powerV
power_vis_linear_ados = powerSim(m3,fixed("I(Visit^2)"),nsim = 50)
power_vis_linear_ados
...
plot(pcinter)
title("Powercurve for interaction between Visit and ADOS1")

pcanden = powerCurve(m3, fixed("I(Visit^2)"), along = "Child.ID", nsim=50)
plot(pcanden)
title("Powercurve for squared Visit")
...
powerV1
power_vis_linear_ados1 = powerSim(m3,fixed("I(Visit^2)"),nsim = 50)
power_vis_linear_ados1
...
pcverbal = powerCurve(m3, fixed("verbalIQ1"), along = "Child.ID", nsim=50)
plot(pcverbal)
title("Power curve for verbalIQ")
pcinter = powerCurve(m3, fixed("Visit:ADOS1"), along = "Child.ID", nsim=50)
plot(pcinter)
...
plot(qqq)
title("powercruve for interaction between Visit and ADOS n = 30")

ppppp = powerSim(p, fixed("I(Visit^2)"), nsim = 50)
ppppp

ppppp1 = powerSim(p, fixed("verbalIQ1"), nsim = 50)
ppppp1

int = powerSim(p, fixed("Visit:ADOS1"), nsim = 50)
